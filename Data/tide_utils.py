...
def load_Port_Townsend(datadir):
    ...
    if not os.path.exists(datadir + '/*PortTownsend.csv'):
        ...
        PortTownsend_2015 = pd.read_csv(datadir + '/2015_PortTownsend.csv', 
        	parse_dates=['Date Time'])
        PortTownsend_2016 = pd.read_csv(datadir + '/2016_PortTownsend.csv',
        	parse_dates=['Date Time'])
...
def load_Port_Angeles(datadir):
    ...
    if not os.path.exists(datadir + '/*PortAngeles.csv'):
        ...
        PortAngeles_2014 = pd.read_csv(datadir + '/2014_PortAngeles.csv',
        	parse_dates=['Date Time'])
        PortAngeles_2015 = pd.read_csv(datadir + '/2015_PortAngeles.csv',
        	parse_dates=['Date Time'])
        PortAngeles_2016 = pd.read_csv(datadir + '/2016_PortAngeles.csv',
        	parse_dates=['Date Time'])
